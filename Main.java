...
String memoryButtonText[] = {"MC", "MR", "MS"};  
...
///////////////////////////  
Main(String frameText)//constructor  
{  
super(frameText);  
...
{  
new Main("Java Calculator by Arman");  
}  
}  
...
case 'R':   
    cl.displayLabel.setText(Main.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
